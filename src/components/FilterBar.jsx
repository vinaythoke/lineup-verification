...
export default function FilterBar({
  ...
  return (
    <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-4 mb-6 shadow-xl backdrop-blur-md">
      ...
      <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3 mb-4">
        ...
        <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-semibold border transition cursor-pointer shrink-0 ${
              filterMismatch
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-6 gap-3 pt-3 border-t border-slate-800/80">
        ...
        <div>
          ...
          >
            ...
            <option value="E">Lineup E</option>
        ...
        <div>
          ...
          >
            ...
            <option value="A">Lineup A</option>
            <option value="B">Lineup B</option>
            <option value="C">Lineup C</option>
        ...
        <div className="col-span-2 sm:col-span-1 md:col-span-5 lg:col-span-1 flex items-end justify-between lg:justify-end gap-2">
