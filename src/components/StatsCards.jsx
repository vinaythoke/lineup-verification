    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
      ...
      <div className="bg-slate-900/70 border border-slate-800 rounded-xl p-3 sm:p-4 flex items-center justify-between shadow-sm">
        <div>
          ...
          <p className="text-[10px] sm:text-[11px] text-slate-500 mt-0.5 hidden sm:block">Lineups E, A, and B requested</p>
        </div>
        <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-400 shrink-0">
      ...
      >
        <div>
          <div className="flex items-center gap-1">
            <p className="text-[10px] sm:text-xs font-semibold text-amber-400 uppercase tracking-wider">AI Discrepancies</p>
            {currentFilterMismatch && (
          ...
          <p className="text-[10px] sm:text-[11px] text-slate-500 mt-0.5 hidden sm:block">Requested section != AI Result</p>
        </div>
      ...
      <div className="bg-slate-900/70 border border-slate-800 rounded-xl p-3 sm:p-4 flex items-center justify-between shadow-sm">
        <div>
          ...
          <p className="text-[10px] sm:text-[11px] text-slate-500 mt-0.5 hidden sm:block">Default state (unless flagged)</p>
        </div>
      ...
      <div className="bg-slate-900/70 border border-slate-800 rounded-xl p-3 sm:p-4 flex items-center justify-between shadow-sm">
        ...
        <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl bg-rose-500/10 border border-rose-500/20 flex items-center justify-center text-rose-400 shrink-0">
